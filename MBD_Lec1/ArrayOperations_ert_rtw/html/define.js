...
this.def["ArrayOperations_U"] = {file: "ArrayOperations_c.html",line:20,type:"var"};
this.def["ArrayOperations_Y"] = {file: "ArrayOperations_c.html",line:23,type:"var"};
this.def["ArrayOperations.c:ArrayOperations_M_"] = {file: "ArrayOperations_c.html",line:26,type:"var"};
this.def["ArrayOperations_M"] = {file: "ArrayOperations_c.html",line:27,type:"var"};
this.def["ArrayOperations_step"] = {file: "ArrayOperations_c.html",line:30,type:"fcn"};
this.def["ArrayOperations_initialize"] = {file: "ArrayOperations_c.html",line:104,type:"fcn"};
this.def["ArrayOperations_terminate"] = {file: "ArrayOperations_c.html",line:123,type:"fcn"};
this.def["ExtU_ArrayOperations_T"] = {file: "ArrayOperations_h.html",line:41,type:"type"};
this.def["ExtY_ArrayOperations_T"] = {file: "ArrayOperations_h.html",line:49,type:"type"};
this.def["RT_MODEL_ArrayOperations_T"] = {file: "ArrayOperations_types_h.html",line:22,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["ArrayOperations_c.html"] = "../ArrayOperations.c";
	this.html2Root["ArrayOperations_c.html"] = "ArrayOperations_c.html";
	this.html2SrcPath["ArrayOperations_h.html"] = "../ArrayOperations.h";
	this.html2Root["ArrayOperations_h.html"] = "ArrayOperations_h.html";
	this.html2SrcPath["ArrayOperations_private_h.html"] = "../ArrayOperations_private.h";
	this.html2Root["ArrayOperations_private_h.html"] = "ArrayOperations_private_h.html";
	this.html2SrcPath["ArrayOperations_types_h.html"] = "../ArrayOperations_types.h";
	this.html2Root["ArrayOperations_types_h.html"] = "ArrayOperations_types_h.html";
...
var fileList = [
"ert_main_c.html","ArrayOperations_c.html","ArrayOperations_h.html","ArrayOperations_private_h.html","ArrayOperations_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html"];
